...
DATABASES = {
    'default': dj_database_url.config(        
        ...
        default='postgresql://library_management_srevice_user:yLFt4gYybPxVEQPJIQKddb7oBZteoLo9@dpg-cur2oh5umphs73f2esp0-a.oregon-postgres.render.com/library_management_srevice',           
    )
}
